...
namespace Leviasan.Sanlog.MSTest
{
    ...
    public sealed class NamedFormatStringUnitTest
    {
        ...
        {
            var format = NamedFormatString.Parse("0x{0:X} {0:E} {0:N}");
            ...
            format = NamedFormatString.Parse("{DateTime:dddd MMMM}");
        ...
        {
            var format = "{1} {0} {2}";
            var namedFormatString = NamedFormatString.Parse(format);
        ...
        {
            var namedFormatString = NamedFormatString.Parse("{0,-20} {1,5:N1}");
